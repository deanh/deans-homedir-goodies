...
;; $URL: svn://rubyforge.org/var/svn/emacs-rails/branches/rinari-merge/rails-ruby.el $
;; $Id: rails-ruby.el 215 2007-10-29 23:13:21Z technomancy $
...
;; This should be an option that the user adds, not enabled by default.
;; (when (featurep 'flymake)
;;   (add-hook 'ruby-mode-hook 'flymake-ruby-load))

(define-key ruby-mode-map (kbd "C-.") 'complete-tag)
;(define-key ruby-mode-map (kbd "TAB") 'indent-or-complete)
(define-key ruby-mode-map (kbd "C-:") 'ruby-toggle-string-to-symbol)
